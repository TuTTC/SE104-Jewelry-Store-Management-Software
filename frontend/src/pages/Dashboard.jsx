...
import { initialData, initialOrders, initialProducts } from '../data/initialData';

const Dashboard = () => {
  const totalRevenue = initialOrders.reduce((acc, order) => acc + Number(order.total.replace('$', '')), 0);
